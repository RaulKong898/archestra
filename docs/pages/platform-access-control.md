...
| `llmProxy:create` | Create new llm proxies for policy evaluation and observability |
| `llmProxy:read` | View and list llm proxies for policy evaluation and observability |
| `llmProxy:update` | Modify existing llm proxies for policy evaluation and observability |
| `llmProxy:delete` | Remove existing llm proxies for policy evaluation and observability |
| `llmProxy:admin` | Administrative control over llm proxies for policy evaluation and observability |
| `mcpGatewayEntity:create` | Create new mcp gateways for tool assignments and execution |
| `mcpGatewayEntity:read` | View and list mcp gateways for tool assignments and execution |
| `mcpGatewayEntity:update` | Modify existing mcp gateways for tool assignments and execution |
| `mcpGatewayEntity:delete` | Remove existing mcp gateways for tool assignments and execution |
| `mcpGatewayEntity:admin` | Administrative control over mcp gateways for tool assignments and execution |
