 ...
 */
export const getMcpGatewayEntities = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntitiesData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntitiesResponses, GetMcpGatewayEntitiesErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities', ...options });
 ...
 */
export const getAllMcpGatewayEntities = <ThrowOnError extends boolean = false>(options?: Options<GetAllMcpGatewayEntitiesData, ThrowOnError>) => (options?.client ?? client).get<GetAllMcpGatewayEntitiesResponses, GetAllMcpGatewayEntitiesErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/all', ...options });

/**
 * Get or create default MCP Gateway
 */
export const getDefaultMcpGatewayEntity = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultMcpGatewayEntityData, ThrowOnError>) => (options?.client ?? client).get<GetDefaultMcpGatewayEntityResponses, GetDefaultMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/default', ...options });

/**
 * Delete an MCP Gateway
 */
export const deleteMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<DeleteMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).delete<DeleteMcpGatewayEntityResponses, DeleteMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/{id}', ...options });

/**
 * Get MCP Gateway by ID
 */
export const getMcpGatewayEntity = <ThrowOnError extends boolean = false>(options: Options<GetMcpGatewayEntityData, ThrowOnError>) => (options.client ?? client).get<GetMcpGatewayEntityResponses, GetMcpGatewayEntityErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/{id}', ...options });
 ...
 */
export const getMcpGatewayEntityLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntityLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntityLabelKeysResponses, GetMcpGatewayEntityLabelKeysErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/labels/keys', ...options });

/**
 * Get all available label values for MCP Gateways
 */
export const getMcpGatewayEntityLabelValues = <ThrowOnError extends boolean = false>(options?: Options<GetMcpGatewayEntityLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<GetMcpGatewayEntityLabelValuesResponses, GetMcpGatewayEntityLabelValuesErrors, ThrowOnError>({ url: '/api/mcp-gateway-entities/labels/values', ...options });
