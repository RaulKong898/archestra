 ...
 */
export const getPublicChatConversation = <ThrowOnError extends boolean = false>(options: Options<GetPublicChatConversationData, ThrowOnError>) => (options.client ?? client).get<GetPublicChatConversationResponses, GetPublicChatConversationErrors, ThrowOnError>({
